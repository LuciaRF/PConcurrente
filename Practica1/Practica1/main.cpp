...
int main(int argc, char **argv) {
  ...
  switch (argc)
  {
	case 2:
	  ...
	  output_file = "Practica1_output.png";
	  reference_file = "Practica1_reference.png";
	  break;
	case 3:
	  input_file  = std::string(argv[1]);
	...
	case 6:
	  ...
	  break;
	default:
      std::cerr << "Usage: ./Practica1 input_file [output_filename] [reference_filename] [perPixelError] [globalError]" << std::endl;
      exit(1);
  }
