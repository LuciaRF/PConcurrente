...
int main(int argc, char **argv) {
  ...
  switch (argc)
  {
	case 2:
	  ...
	  output_file = "PR2_output.png";
	  reference_file = "PR2_reference.png";
	  break;
	case 3:
	  input_file  = std::string(argv[1]);
	...
	case 6:
	  ...
	  break;
	default:
      std::cerr << "Usage: ./Practica2 input_file [output_filename] [reference_filename] [perPixelError] [globalError]" << std::endl;
      exit(1);
  }
